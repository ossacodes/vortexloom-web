<!-- =========={ FOOTER }==========  -->
<footer class="text-gray-700 bg-gray-50">
    <!--Footer content-->
    <div id="footer-content" class="relative pt-8 pb-6 xl:pt-16 xl:pb-12">
      <div class="container px-4 mx-auto overflow-hidden xl:max-w-6xl">
        <div class="flex flex-row flex-wrap -mx-3 lg:justify-between">
          ...
          <div class="flex-shrink w-full max-w-full px-3 lg:w-3/5">
            <div class="flex flex-row flex-wrap">
              ...
              <div class="flex-shrink w-1/2 max-w-full mb-6 md:w-1/3 lg:mb-0">
                <h4 class="mb-3 text-base leading-normal text-gray-800 uppercase">Legal</h4>
                <ul>
    ...
    <div class="footer-dark">
      <div class="container px-4 py-4 mx-auto border-t border-gray-200 xl:max-w-6xl border-opacity-10">
        <div class="row">
          <div class="text-center col-12 col-md">
            <p class="my-3 d-block">Copyright © VortexLoom Ltd | All rights reserved.</p>
          </div>
        </div>
      </div>
