...
<div id="contact" class="relative pb-20 bg-white section dark:bg-gray-800">
    <div class="container px-4 mx-auto xl:max-w-6xl">
      <div class="flex flex-row flex-wrap justify-center -mx-4">
        <div class="w-full px-4 max-w-ful lg:w-8/12">
          <div class="w-full p-12 border-b border-gray-100 bg-gray-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
            <!-- section header -->
            <header class="mx-auto mb-12 text-center lg:px-20">
              <h2 class="mb-2 text-2xl font-bold leading-normal text-gray-800 dark:text-gray-100"><span class="font-light">Contact</span> Us</h2>
              ...
              <p class="pb-2 mx-auto text-xl font-light leading-relaxed text-gray-600">Have questions about service, please contact us.</p>
