<!-- Team start -->
<div id="team" class="relative pt-20 pb-8 bg-white section md:pt-16 dark:bg-gray-800">
<div class="container px-4 mx-auto xl:max-w-6xl">
    <!-- section header -->
    <header class="mx-auto mb-12 text-center">
    <h2 class="mb-2 text-2xl font-bold leading-normal text-gray-800 dark:text-gray-100"><span class="font-light">Our</span> Team</h2>
    ...
    <div class="flex-shrink w-2/3 max-w-full px-4 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
